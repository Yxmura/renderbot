...
@self.bot.slash_command(name="createrolemenu", description="Create a role selection menu")
...
@self.bot.slash_command(name="deleterolemenu", description="Delete a role selection menu")
@app_commands.default_permissions(administrator=True)
@app_commands.describe(
