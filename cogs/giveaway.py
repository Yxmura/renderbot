...
class GiveawayCog(discord.Cog):
    ...
    @self.bot.slash_command(name="creategiveaway", description="Create a new giveaway")
    ...
    @self.bot.slash_command(name="setupgiveaway", description="Setup the giveaway system")
