...
class Ticket_Command(commands.Cog):
    ...
    @discord.slash_command(name="ticket", description="Sends the ticket creation panel.")
    ...
    @discord.slash_command(name="add", description="Add a Member to the Ticket")
    ...
    @discord.slash_command(name="remove", description="Remove a Member from the Ticket")
    ...
    @discord.slash_command(name="delete", description="Delete the Ticket")
    async def delete_ticket(self, ctx):
        ...
        transcript_info = discord.Embed(title=f"Ticket Deleted | {ctx.channel.name}", color=discord.colour.Color.purple())
